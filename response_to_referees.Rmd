...
1. the measure referred to as `foodweb_diversity` (P8 L159) is identical to the
 ...
 > This measure is indeed identical to the evenness component of the Shannon
 index, we agree that the use of the term *diversity* may be confusing for users
 and changed the name of this function to `foodweb_evenness` as suggested by the
 reviewer.
